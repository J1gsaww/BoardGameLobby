...
const DICT = {
  th: {
    ...
    'cards.clear': 'ล้าง',
    'lobby.devMode': 'โหมดทดสอบ — เริ่มได้โดยไม่ต้องครบจำนวนคนและไม่ต้องกดพร้อม',
    'lobby.devOn': 'โหมดทดสอบเปิดอยู่',
    'cat.all': 'ทุกเกม',
    'cat.card': 'เกมไพ่',
    'cat.board': 'บอร์ดเกม',
  ...
  en: {
    ...
    'cards.clear': 'Clear',
    'lobby.devMode': 'Test mode — start without the required player count or ready checks',
    'lobby.devOn': 'Test mode is on',
    'cat.all': 'All games',
