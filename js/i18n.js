...
const DICT = {
  th: {
    ...
    'lobby.search': 'ค้นหาเกม',
    'lobby.noMatch': 'ไม่เจอเกมที่ตรงกับที่ค้นหา',
    'cards.added': 'ใส่เพิ่มแล้ว {n} ใบ',
    'db.back': 'กดเพื่อกลับไปฐานข้อมูลหลัก',
    'db.confirm': 'กลับไปใช้ฐานข้อมูลหลักไหม หน้าจะโหลดใหม่และออกจากห้องปัจจุบัน',
    'lobby.closeRoom': 'ปิดห้อง',
    'lobby.closeRoomSure': 'กดอีกครั้ง — ทุกคนจะถูกเตะออก',
    'cards.add': 'เพิ่มการ์ดพิเศษ',
    'cards.hide': 'ซ่อนรายการการ์ด',
    'cards.addAll': 'ใส่ทั้งหมด',
    'cards.random': 'สุ่ม {n} ชุด',
    'cards.clear': 'ล้าง',
    'cat.all': 'ทุกเกม',
    'cat.card': 'เกมไพ่',
    'cat.board': 'บอร์ดเกม',
  ...
  en: {
    ...
    'lobby.noMatch': 'No games match that search',
    'cards.added': '{n} card(s) added',
    'db.back': 'click to switch back to the main database',
    'db.confirm': 'Switch back to the main database? The page will reload and leave this room.',
    'lobby.closeRoom': 'Close room',
    'lobby.closeRoomSure': 'Tap again \u2014 everyone gets kicked',
    'cards.add': 'Add Special Card',
    'cards.hide': 'Hide the list',
    'cards.addAll': 'Add all',
    'cards.random': 'Random {n}',
    'cards.clear': 'Clear',
    'cat.all': 'All games',
    'cat.card': 'Playing card games',
