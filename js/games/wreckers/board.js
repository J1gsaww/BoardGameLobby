...
/* กล่องบนเรือวางเป็นแนวตั้งเรียงลงมา ไม่ใช่แนวนอน
   ช่องเก็บของบนเรือเป็นช่องแคบยาว กล่องแนวนอนกินความกว้างจนต้องเว้นห่างกันมาก
   พอตั้งกล่องขึ้นก็วางชิดกันได้ ระยะห่างจึงลดจาก 12.5 เหลือ 9.5 */
export const SHIP_CARGO = {
  B: [{ x: 34.5, y: 44, r: 0 }, { x: 34.5, y: 53.5, r: 0 }, { x: 34.5, y: 63, r: 0 }],
  F: [{ x: 63.9, y: 44, r: 0 }, { x: 63.9, y: 53.5, r: 0 }, { x: 63.9, y: 63, r: 0 }]
};
/* บังคับสัดส่วนเอง ไม่พึ่งสัดส่วนของไฟล์ภาพ
   เปลี่ยนไฟล์ภาพเมื่อไหร่กล่องก็ยังตั้งเหมือนเดิม ไม่พลิกเป็นแนวนอนอีก */
export const SHIP_CARGO_SIZE = 9;
export const SHIP_CARGO_TALL = 13;
