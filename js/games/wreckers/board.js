...
/* เพดานเวลาของช่วงเลือกเป้าการ์ด — ไม่ผูกกับเวลาต่อตา
   เพราะช่วงนี้เกิดขึ้นได้แม้ในโหมดไม่จับเวลา และทั้งวงต้องรอคนเดียว */
export const PICK_MS = 90000;

/* บางใบต้องคิดนานกว่าปกติจริง ๆ จึงได้เวลาเพิ่มเฉพาะใบ
   รังกาต้องดูไพ่ทั้งกองแล้วเลือกสามใบให้คนอื่น กินเวลามากที่สุดในสำรับ
   ใบที่คลิกทีเดียวจบไม่ควรอืดตามไปด้วย จึงแยกเป็นรายใบแทนการขยับเพดานรวม */
export const PICK_MS_BY_CARD = { crowsnest: 120000 };

export const pickMs = (card) => PICK_MS_BY_CARD[card] || PICK_MS;
