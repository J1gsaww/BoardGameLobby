...
function sceneKey(st) {
  ...
  /* ขั้นถามที่ไม่ได้มาจากการ์ด (เช่นการบังคับให้เปิด) มีฉากของตัวเอง

     เช็กว่าการ์ดที่ค้างอยู่เป็น **ใบเดียวกับที่ขั้นนี้ถามถึง** ไม่ใช่แค่ว่ามีการ์ดค้างอยู่ไหม
     เพราะการ์ดที่เพิ่งเปิดไปอยู่ในสถานะข้ามตาได้ พอสั่ง Force รอบใหม่
     ฉากจะไปหยิบใบเก่ามาแสดงแทนขั้นเลือกคน แล้วกดอะไรไม่ได้เลย
     อาการจะสลับรอบเว้นรอบ เพราะรอบถัดไปการ์ดที่ค้างเป็นของ Force เองแล้ว */
  if (st.pending && st.pending.card !== st.cardUp?.id) return `ask:${st.pending.at}`;
