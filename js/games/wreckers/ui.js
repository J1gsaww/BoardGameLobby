...
/* ยาวพอให้ทันเห็นตอนฉากประกาศกำลังเล่าอยู่ ซึ่งกินเวลาราวสองวินาทีครึ่ง */
const GLOW_MS = 3200;
let glowAt = 0;
let glowKey = 0;
...
export function render(el, ctx) {
  ...
  el.querySelectorAll('.wr-slot').forEach(b => {
    ...
    /* ป่วยจนติดหนี้ข้ามตา — เรืองค้างไว้จนกว่าจะถูกข้ามจริงแล้วหนี้หมด
       ...
       ตัวจับเวลาจะดับก่อนที่ผลจะหมด ซึ่งทำให้เข้าใจผิดว่าปลอดภัยแล้ว */
    b.classList.toggle('sick', !!uid && (view.skip?.[uid] || 0) > 0);
