  ...
  th: [
    {
      ...
      p: [
        ...
        'ดอกดาวใส่เข้ามาเพื่อให้แต้มหนึ่งมีครบห้าใบ ทุกแต้มจึงมีโอกาสเท่ากัน',
    ...
    },
    {
      h: 'กระดานคะแนน',
      p: [
        'มี 13 ช่อง ลงได้ช่องละครั้งเดียวทั้งเกม จึงเล่นคนละ 13 รอบ',
    ...
    },
    {
      ...
      p: [
        ...
        'ฟูลเฮาส์ 25 แต้ม · เสตรทเรียงห้าใบเต็ม 35 แต้ม'
      ]
    },
    {
      h: 'จบเกม',
      p: [
        'เกมจบเมื่อทั้งสองคนลงครบทั้ง 13 ช่อง',
  ...
  en: [
    {
      ...
      p: [
        ...
        'The star suit exists so every rank has five cards, giving every rank the same odds',
    ...
    },
    {
      h: 'The score sheet',
      p: [
        'Thirteen rows, each usable once per game, so you play thirteen rounds each',
    ...
    },
    {
      ...
      p: [
        ...
        'Full house 25 · a full five-card straight 35'
      ]
    },
    {
      h: 'Ending the game',
